...
import { UpdatePermissionDto } from 'services'
...
export default function PermissionsEdit() {
    ...
    const [updatePermission, { isLoading: isSubmitting }] = useUpdatePermissionMutation()
    ...
    return <Page title="ویرایش دسترسی" loading={isLoading}>
