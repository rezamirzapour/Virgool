...
import { ApiBearerAuth, ApiForbiddenResponse, ApiUnauthorizedResponse, ApiInternalServerErrorResponse, ApiCreatedResponse } from '@nestjs/swagger';
...
export function PostMethod(path: string | string[] = "", options?: Partial<Options>) {
