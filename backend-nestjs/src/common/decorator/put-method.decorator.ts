...
import { ApiBearerAuth, ApiForbiddenResponse, ApiUnauthorizedResponse, ApiInternalServerErrorResponse, ApiOkResponse, ApiNotFoundResponse, ApiBadRequestResponse } from '@nestjs/swagger'
...
export function PutMethod(path: string | string[], options?: Partial<Options>) {
    ...
    return applyDecorators(
        ...
        ApiBadRequestResponse({ description: combinedOptions.apiBadRequestDescription })
    );
}